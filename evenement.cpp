...
Evenement::Evenement(int idevenement,QString nomevenement,QString typeevenement,int prixevenment, int tempsevenement)
{
...
bool Evenement:: modifier(int idevenement,QString nomevenement,QString typeevenement,int prixevenement,int tempsevenement)
{QSqlQuery query;
    QString res= QString::number(idevenement);
    QString res2= QString::number(prixevenement);
    QString res3= QString::number(tempsevenement);
