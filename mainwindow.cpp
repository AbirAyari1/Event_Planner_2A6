...
ui->comboBox_TYPE_marchandise->setModel(tmpmarchandise.afficher_type());
...
void MainWindow::on_pushButton_imprimer_commande_clicked()
{
    //QDateTime datecreation = date.currentDateTime();
        //QString afficheDC = "Date de Creation PDF : " + datecreation.toString() ;
               QPdfWriter pdf("C:/Users/amen/Desktop/amen/Pdf.pdf");
              ...
              int i = 4000;
                  ...
                  // painter.drawText(1100,2000,afficheDC);
                   ...
                   int reponse = QMessageBox::question(this, "Génerer PDF", "<PDF Enregistré>...Vous Voulez Affichez Le PDF ?", QMessageBox::Yes |  QMessageBox::No);
                       ...
                       {
                           QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/amen/Desktop/amen/Pdf.pdf"));
                           painter.end();
                       }
...
{
    Smtp* smtp = new Smtp("amen.benkhalifaaa9@gmail.com","amenamen123","smtp.gmail.com",465);
